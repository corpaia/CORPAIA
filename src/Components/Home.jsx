        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-6">
          <div className="max-w-6xl mx-auto px-4 text-center">
            <div className="relative">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold bg-gradient-to-r from-[#a43f97] to-[#f36f28] bg-clip-text text-transparent mb-4 leading-tight sm:leading-tight  relative z-10">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Deploy smart AI agents to automate daily tasks, streamline
              operations, and empower your team to focus on what truly matters.
            </p>
